...
module.exports = {
  ...
  mac: {
    ...
    extendInfo: {
      ...
      NSMicrophoneUsageDescription:
        "EchoDraft needs microphone access for speech-to-text transcription.",
      NSAccessibilityUsageDescription:
        "EchoDraft needs accessibility permissions to paste transcribed text into other applications.",
    },
  },
  win: {
  ...
  nsis: {
    ...
    installerIcon: ICON_ASSET_PATHS.windows,
    uninstallerIcon: ICON_ASSET_PATHS.windows,
    installerHeaderIcon: ICON_ASSET_PATHS.windows,
